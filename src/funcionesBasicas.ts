...
export function loggerMeta(log: string) {
  ...
  const tiempo: string = dia(ahora.getDay()) + ' ' + ahora.getDate().toString() + ' ' + mes(ahora.getMonth()) 
    + ' ' +  ahora.getFullYear().toString() + ' ' + ahora.getHours().toString() + ' ' + 
    ahora.getMinutes().toString() + ' ' + ahora.getSeconds().toString();
  mensaje = tiempo + '\n' + log + '\n' + mensaje + '\n'
...
export function obtenerNota(): {id: number, titulo: string, contenido: string}[] {
...
export function obtenerHora(): string {
  ...
  enunciado = enunciado + "con " + ahora.getMinutes() + " y " + ahora.getSeconds() + 
    " segundos"
...
export function obtenerFecha(): string {
  const ahora = new Date
  let enunciado: string = "Hoy es " + dia(ahora.getDay()) + " " + ahora.getDate() + " de " + 
    mes(ahora.getMonth()) + " del " + ahora.getFullYear()

  return enunciado;
}

export function argumentosCmd(ctx:Context, numeroArgs?: number): Array<string> {
